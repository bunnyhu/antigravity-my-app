...
Ez a kód nem tartalmaz semmilyen emberi fejlesztési elemet. Sőt ez a README.md fájl sem, de még ennek a bekezdésnek a tartalmát is néha az AI javasolta. A project célja a Google új Antigravity környezetének és a Gemini 3 Pro model tesztelése. Én csak promptot írtam méghozzá magyarul, és teszteltem - de a tesztelést is az AI írta le, mit csináljak. Ha valami nem tetszett leírtam emberi mondatokkal, ha hibát kaptam csak bemásoltam. 4 forduló után a kód hibátlanul futott. Itt tartunk most 2025 év végén.
